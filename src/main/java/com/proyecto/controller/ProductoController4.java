...
//    }
    ...
    public String inicio(Model model) {
        var productos = productoService.getProductos(false);
        var productosCategoria4 = productos.stream()
                .filter(producto -> producto.getIdCategoria() == 4)// Filtra los productos de la categoría 1
                .collect(Collectors.toList());
        model.addAttribute("productos", productosCategoria4);
        model.addAttribute("totalProductos", productosCategoria4.size());
        return "/producto4/listado";
    }
